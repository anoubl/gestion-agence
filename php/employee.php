    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item" href="conger_e.php">Demande congé</a></li>
            <li><a class="dropdown-item" href="absence_e.php">Consulter Les Absences</a></li>
            <li><a class="dropdown-item" href="missions.php">Consulter les missions</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
